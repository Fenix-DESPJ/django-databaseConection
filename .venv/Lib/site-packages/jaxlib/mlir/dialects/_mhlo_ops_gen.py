...
class AllGatherOp(_ods_ir.OpView):
  ...
  def __init__(self, result: _Sequence[_ods_ir.Type], operands_: _Sequence[_ods_ir.Value[_ods_ir.RankedTensorType]], all_gather_dim: _Union[int, _ods_ir.IntegerAttr], replica_groups: _Union[_Any, _ods_ir.Attribute], *, channel_handle: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, use_global_device_ids: _Optional[bool] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    not _ods_ir.AttrBuilder.contains('MHLO_ReplicaGroups')) else
      _ods_ir.AttrBuilder.get('MHLO_ReplicaGroups')(replica_groups, context=_ods_context))
...
class AllToAllOp(_ods_ir.OpView):
  ...
  def __init__(self, operand: _Sequence[_ods_ir.Value[_ods_ir.RankedTensorType]], replica_groups: _Union[_Any, _ods_ir.Attribute], *, split_dimension: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, concat_dimension: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, split_count: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, channel_handle: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, results: _Optional[_Sequence[_ods_ir.Type]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
...
class CustomCallOp(_ods_ir.OpView):
  ...
  def __init__(self, result: _Sequence[_ods_ir.Type], inputs: _Sequence[_ods_ir.Value], call_target_name: _Union[str, _ods_ir.StringAttr], *, has_side_effect: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, backend_config: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, api_version: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, called_computations: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, custom_call_schedule: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, operand_layouts: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, result_layouts: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, output_operand_aliases: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    if backend_config is not None: attributes["backend_config"] = (backend_config if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_902')) else
          _ods_ir.AttrBuilder.get('anonymous_902')(backend_config, context=_ods_context))
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_909')) else
          _ods_ir.AttrBuilder.get('anonymous_909')(output_operand_aliases, context=_ods_context))
    results = []
    results.extend(result)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class FusionOp(_ods_ir.OpView):
  ...
  def __init__(self, results_: _Sequence[_ods_ir.Type], inputs: _Sequence[_ods_ir.Value], *, fusion_kind: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, output_operand_aliases: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        isinstance(output_operand_aliases, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_945')) else
          _ods_ir.AttrBuilder.get('anonymous_945')(output_operand_aliases, context=_ods_context))
    results = []
...
@_ods_cext.register_operation(_Dialect)
class MulhiOp(_ods_ir.OpView):
  r"""
  Performs element-wise multiplication of two integer tensors `lhs` and `rhs`,
  returning the most significant bits of the product.
  """

  OPERATION_NAME = "mhlo.mulhi"
...
@_ods_cext.register_op_adaptor(MulhiOp)
class MulhiOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "mhlo.mulhi"
...
class ScanOp(_ods_ir.OpView):
  ...
  def __init__(self, outputs: _Sequence[_ods_ir.Type], carries: _Sequence[_ods_ir.Type], inputs: _Sequence[_ods_ir.Value[_ods_ir.RankedTensorType]], inits: _Sequence[_ods_ir.Value[_ods_ir.RankedTensorType]], dimension: _Union[int, _ods_ir.IntegerAttr], *, scan_dim_size: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, is_reverse: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, is_associative: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    ...
    not _ods_ir.AttrBuilder.contains('I64Attr')) else
      _ods_ir.AttrBuilder.get('I64Attr')(dimension, context=_ods_context))
    if scan_dim_size is not None: attributes["scan_dim_size"] = (scan_dim_size if (
        isinstance(scan_dim_size, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('I64Attr')) else
          _ods_ir.AttrBuilder.get('I64Attr')(scan_dim_size, context=_ods_context))
  ...
  @builtins.property
  def scan_dim_size(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "scan_dim_size" not in self.operation.attributes:
      return None
    return self.operation.attributes["scan_dim_size"]

  @scan_dim_size.setter
  def scan_dim_size(self, value: _Optional[_ods_ir.IntegerAttr]):
    if value is not None:
      self.operation.attributes["scan_dim_size"] = value
    elif "scan_dim_size" in self.operation.attributes:
      del self.operation.attributes["scan_dim_size"]

  @scan_dim_size.deleter
  def scan_dim_size(self):
    del self.operation.attributes["scan_dim_size"]
...
class ScanOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def scan_dim_size(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "scan_dim_size" not in self.attributes:
      return None
    return self.attributes["scan_dim_size"]
