...
@register_attribute_builder("FPRoundingMode", allow_existing=True)
...
class SaturationMode(IntEnum):
    ...
    def __str__(self):
        ...
        if self is SaturationMode.SATFINITE:
            return "satfinite"
        if self is SaturationMode.SAT:
            return "sat"
        raise ValueError("Unknown SaturationMode enum entry.")



@register_attribute_builder("SaturationMode", allow_existing=True)
