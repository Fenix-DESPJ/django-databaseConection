...
class ScanOp(_ods_ir.OpView):
  ...
  def __init__(self, outputs: _Sequence[_ods_ir.Type], carries: _Sequence[_ods_ir.Type], inputs: _Sequence[_ods_ir.Value], inits: _Sequence[_ods_ir.Value], dimension: _Union[int, _ods_ir.IntegerAttr], *, scan_dim_size: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, is_reverse: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, is_associative: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
