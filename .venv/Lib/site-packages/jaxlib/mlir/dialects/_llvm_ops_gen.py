...
class CallOp(_ods_ir.OpView):
  ...
  def __init__(self, result: _Optional[_ods_ir.Type], callee_operands: _Sequence[_ods_ir.Value], op_bundle_operands: _Sequence[_ods_ir.Value], op_bundle_sizes: _Union[_Sequence[int], _ods_ir.DenseI32ArrayAttr], *, var_callee_type: _Optional[_Union[_Any, _ods_ir.TypeAttr]] = None, callee: _Optional[_Union[str, _ods_ir.FlatSymbolRefAttr]] = None, fastmathFlags: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, CConv: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, TailCallKind: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, memory_effects: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, convergent: _Optional[bool] = None, no_unwind: _Optional[bool] = None, will_return: _Optional[bool] = None, noreturn: _Optional[bool] = None, returns_twice: _Optional[bool] = None, hot: _Optional[bool] = None, cold: _Optional[bool] = None, noduplicate: _Optional[bool] = None, no_caller_saved_registers: _Optional[bool] = None, nocallback: _Optional[bool] = None, modular_format: _Optional[_Union[str, _ods_ir.StringAttr]] = None, nobuiltins: _Optional[_Union[_Sequence[_ods_ir.Attribute], _ods_ir.ArrayAttr]] = None, allocsize: _Optional[_Union[_Sequence[int], _ods_ir.DenseI32ArrayAttr]] = None, optsize: _Optional[bool] = None, minsize: _Optional[bool] = None, builtin: _Optional[bool] = None, nobuiltin: _Optional[bool] = None, save_reg_params: _Optional[bool] = None, zero_call_used_regs: _Optional[_Union[str, _ods_ir.StringAttr]] = None, trap_func_name: _Optional[_Union[str, _ods_ir.StringAttr]] = None, default_func_attrs: _Optional[_Union[dict, _ods_ir.DictAttr]] = None, op_bundle_tags: _Optional[_Union[_Sequence[_ods_ir.Attribute], _ods_ir.ArrayAttr]] = None, arg_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, res_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, no_inline: _Optional[bool] = None, always_inline: _Optional[bool] = None, inline_hint: _Optional[bool] = None, access_groups: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, alias_scopes: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, noalias_scopes: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, tbaa: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    if var_callee_type is not None: attributes["var_callee_type"] = (var_callee_type if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_1021')) else
          _ods_ir.AttrBuilder.get('anonymous_1021')(var_callee_type, context=_ods_context))
...
class FPExtOp(_ods_ir.OpView):
  ...
  def __init__(self, res: _ods_ir.Type, arg: _ods_ir.Value, *, fastmathFlags: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(arg)
...
class LLVMFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name: _Union[str, _ods_ir.StringAttr], function_type: _Union[_Any, _ods_ir.TypeAttr], *, sym_visibility: _Optional[_Union[str, _ods_ir.StringAttr]] = None, linkage: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, dso_local: _Optional[bool] = None, CConv: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, comdat: _Optional[_Union[str, _ods_ir.SymbolRefAttr]] = None, convergent: _Optional[bool] = None, personality: _Optional[_Union[str, _ods_ir.FlatSymbolRefAttr]] = None, garbageCollector: _Optional[_Union[str, _ods_ir.StringAttr]] = None, passthrough: _Optional[_Union[_Sequence[_ods_ir.Attribute], _ods_ir.ArrayAttr]] = None, arg_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, res_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, function_entry_count: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, memory_effects: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, visibility_: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, arm_streaming: _Optional[bool] = None, arm_locally_streaming: _Optional[bool] = None, arm_streaming_compatible: _Optional[bool] = None, arm_new_za: _Optional[bool] = None, arm_in_za: _Optional[bool] = None, arm_out_za: _Optional[bool] = None, arm_inout_za: _Optional[bool] = None, arm_preserves_za: _Optional[bool] = None, section: _Optional[_Union[str, _ods_ir.StringAttr]] = None, unnamed_addr: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, alignment: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, vscale_range: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, frame_pointer: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, target_cpu: _Optional[_Union[str, _ods_ir.StringAttr]] = None, tune_cpu: _Optional[_Union[str, _ods_ir.StringAttr]] = None, reciprocal_estimates: _Optional[_Union[str, _ods_ir.StringAttr]] = None, prefer_vector_width: _Optional[_Union[str, _ods_ir.StringAttr]] = None, target_features: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, no_signed_zeros_fp_math: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, denormal_fpenv: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, fp_contract: _Optional[_Union[str, _ods_ir.StringAttr]] = None, instrument_function_entry: _Optional[_Union[str, _ods_ir.StringAttr]] = None, instrument_function_exit: _Optional[_Union[str, _ods_ir.StringAttr]] = None, no_inline: _Optional[bool] = None, always_inline: _Optional[bool] = None, inline_hint: _Optional[bool] = None, no_unwind: _Optional[bool] = None, will_return: _Optional[bool] = None, noreturn: _Optional[bool] = None, optimize_none: _Optional[bool] = None, returns_twice: _Optional[bool] = None, hot: _Optional[bool] = None, cold: _Optional[bool] = None, noduplicate: _Optional[bool] = None, no_caller_saved_registers: _Optional[bool] = None, nocallback: _Optional[bool] = None, modular_format: _Optional[_Union[str, _ods_ir.StringAttr]] = None, nobuiltins: _Optional[_Union[_Sequence[_ods_ir.Attribute], _ods_ir.ArrayAttr]] = None, allocsize: _Optional[_Union[_Sequence[int], _ods_ir.DenseI32ArrayAttr]] = None, optsize: _Optional[bool] = None, minsize: _Optional[bool] = None, save_reg_params: _Optional[bool] = None, zero_call_used_regs: _Optional[_Union[str, _ods_ir.StringAttr]] = None, default_func_attrs: _Optional[_Union[dict, _ods_ir.DictAttr]] = None, vec_type_hint: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, work_group_size_hint: _Optional[_Union[_Sequence[int], _ods_ir.DenseI32ArrayAttr]] = None, reqd_work_group_size: _Optional[_Union[_Sequence[int], _ods_ir.DenseI32ArrayAttr]] = None, intel_reqd_sub_group_size: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, uwtable_kind: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, use_sample_profile: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1021')) else
      _ods_ir.AttrBuilder.get('anonymous_1021')(function_type, context=_ods_context))
...
@_ods_cext.register_operation(_Dialect)
class MetadataAsValueOp(_ods_ir.OpView):
  r"""
  ...
  * `#llvm.md_node<...>` -> `llvm::MDNode` over any of the above.
  ...
  OPERATION_NAME = "llvm.mlir.metadata_as_value"

  _ODS_REGIONS = (0, True)

  def __init__(self, metadata: _Union[_Any, _ods_ir.Attribute], *, results: _Optional[_Sequence[_ods_ir.Type]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    _ods_context = _ods_get_default_loc_context(loc)
    ...
    not _ods_ir.AttrBuilder.contains('LLVM_AnyMDAttr')) else
      _ods_ir.AttrBuilder.get('LLVM_AnyMDAttr')(metadata, context=_ods_context))
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)

  @builtins.property
  def metadata(self) -> _ods_ir.Attribute:
    return self.operation.attributes["metadata"]

  @metadata.setter
  def metadata(self, value: _ods_ir.Attribute):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
...
@_ods_cext.register_op_adaptor(MetadataAsValueOp)
class MetadataAsValueOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "llvm.mlir.metadata_as_value"

  @builtins.property
  def metadata(self) -> _ods_ir.Attribute:
    return self.attributes["metadata"]
