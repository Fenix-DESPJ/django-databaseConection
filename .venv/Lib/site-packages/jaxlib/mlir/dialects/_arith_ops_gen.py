...
class AddFOp(_ods_ir.OpView):
  ...
  def __init__(self, lhs: _ods_ir.Value, rhs: _ods_ir.Value, *, fastmath: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, roundingmode: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, results: _Optional[_Sequence[_ods_ir.Type]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(lhs)
...
@_ods_cext.register_operation(_Dialect)
class FlushDenormalsOp(_ods_ir.OpView):
  r"""
  ...
  OPERATION_NAME = "arith.flush_denormals"
...
@_ods_cext.register_op_adaptor(FlushDenormalsOp)
class FlushDenormalsOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "arith.flush_denormals"
...
@_ods_cext.register_operation(_Dialect)
class SubUIExtendedOp(_ods_ir.OpView):
  r"""
  ...
  OPERATION_NAME = "arith.subui_extended"

  _ODS_REGIONS = (0, True)

  def __init__(self, diff: _ods_ir.Type, borrow: _ods_ir.Type, lhs: _ods_ir.Value, rhs: _ods_ir.Value, *, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(lhs)
  ...
  @builtins.property
  def diff(self) -> _ods_ir.OpResult:
    return self.operation.results[0]

  @builtins.property
  def borrow(self) -> _ods_ir.OpResult:
    return self.operation.results[1]

@_ods_cext.register_op_adaptor(SubUIExtendedOp)
class SubUIExtendedOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "arith.subui_extended"
