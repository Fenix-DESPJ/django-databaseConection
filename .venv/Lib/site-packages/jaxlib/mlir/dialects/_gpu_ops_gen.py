...
class BarrierOp(_ods_ir.OpView):
  ...
  def __init__(self, *, address_spaces: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, named_barrier: _Optional[_ods_ir.Value] = None, scope: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    if named_barrier is not None: operands.append(named_barrier)
    _ods_context = _ods_get_default_loc_context(loc)
    ...
    if scope is not None: attributes["scope"] = (scope if (
        ...
        not _ods_ir.AttrBuilder.contains('gpu.GPU_BarrierScopeAttr')) else
          _ods_ir.AttrBuilder.get('gpu.GPU_BarrierScopeAttr')(scope, context=_ods_context))
    results = []
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)

  @builtins.property
  def named_barrier(self) -> _Optional[_ods_ir.Value]:
...
class GPUFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type: _Union[_Any, _ods_ir.TypeAttr], *, arg_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, res_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, workgroup_attrib_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, private_attrib_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, known_block_size: _Optional[_Union[_Any, _ods_ir.DenseI32ArrayAttr]] = None, known_grid_size: _Optional[_Union[_Any, _ods_ir.DenseI32ArrayAttr]] = None, known_cluster_size: _Optional[_Union[_Any, _ods_ir.DenseI32ArrayAttr]] = None, workgroup_attributions: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, kernel: _Optional[bool] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_656')) else
      _ods_ir.AttrBuilder.get('anonymous_656')(function_type, context=_ods_context))
    ...
    if workgroup_attributions is not None: attributes["workgroup_attributions"] = (workgroup_attributions if (
        isinstance(workgroup_attributions, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('I64Attr')) else
          _ods_ir.AttrBuilder.get('I64Attr')(workgroup_attributions, context=_ods_context))
    if bool(kernel): attributes["kernel"] = _ods_ir.UnitAttr.get(
      _ods_get_default_loc_context(loc))
    results = []
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
  ...
  @builtins.property
  def workgroup_attributions(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "workgroup_attributions" not in self.operation.attributes:
      return None
    return self.operation.attributes["workgroup_attributions"]

  @workgroup_attributions.setter
  def workgroup_attributions(self, value: _Optional[_ods_ir.IntegerAttr]):
    if value is not None:
      self.operation.attributes["workgroup_attributions"] = value
    elif "workgroup_attributions" in self.operation.attributes:
      del self.operation.attributes["workgroup_attributions"]

  @workgroup_attributions.deleter
  def workgroup_attributions(self):
    del self.operation.attributes["workgroup_attributions"]

  @builtins.property
  def kernel(self) -> bool:
    return "kernel" in self.operation.attributes

  @kernel.setter
  def kernel(self, value):
    if bool(value):
      self.operation.attributes["kernel"] = _ods_ir.UnitAttr.get()
    elif "kernel" in self.operation.attributes:
      del self.operation.attributes["kernel"]
...
class GPUFuncOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def workgroup_attributions(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "workgroup_attributions" not in self.attributes:
      return None
    return self.attributes["workgroup_attributions"]

  @builtins.property
  def kernel(self) -> bool:
    return "kernel" in self.attributes
...
def func(function_type: _Union[_Any, _ods_ir.TypeAttr], *, arg_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, res_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, workgroup_attrib_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, private_attrib_attrs: _Optional[_Union[_Any, _ods_ir.ArrayAttr]] = None, known_block_size: _Optional[_Union[_Any, _ods_ir.DenseI32ArrayAttr]] = None, known_grid_size: _Optional[_Union[_Any, _ods_ir.DenseI32ArrayAttr]] = None, known_cluster_size: _Optional[_Union[_Any, _ods_ir.DenseI32ArrayAttr]] = None, workgroup_attributions: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, kernel: _Optional[bool] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None) -> GPUFuncOp:
  return GPUFuncOp(function_type=function_type, arg_attrs=arg_attrs, res_attrs=res_attrs, workgroup_attrib_attrs=workgroup_attrib_attrs, private_attrib_attrs=private_attrib_attrs, known_block_size=known_block_size, known_grid_size=known_grid_size, known_cluster_size=known_cluster_size, workgroup_attributions=workgroup_attributions, kernel=kernel, loc=loc, ip=ip)
...
@_ods_cext.register_operation(_Dialect)
class InitializeNamedBarrierOp(_ods_ir.OpView):
  r"""
  ...
  OPERATION_NAME = "gpu.initialize_named_barrier"

  _ODS_REGIONS = (0, True)

  def __init__(self, member_count: _ods_ir.Value[_ods_ir.IntegerType], *, results: _Optional[_Sequence[_ods_ir.Type]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(member_count)
    _ods_context = _ods_get_default_loc_context(loc)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)

  @builtins.property
  def member_count(self) -> _ods_ir.Value[_ods_ir.IntegerType]:
    return self.operation.operands[0]
...
@_ods_cext.register_op_adaptor(InitializeNamedBarrierOp)
class InitializeNamedBarrierOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "gpu.initialize_named_barrier"
...
class LaunchFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, asyncToken: _Optional[_ods_ir.Type], asyncDependencies: _Sequence[_ods_ir.Value], kernel: _Union[str, _ods_ir.SymbolRefAttr], gridSizeX: _ods_ir.Value, gridSizeY: _ods_ir.Value, gridSizeZ: _ods_ir.Value, blockSizeX: _ods_ir.Value, blockSizeY: _ods_ir.Value, blockSizeZ: _ods_ir.Value, kernelOperands: _Sequence[_ods_ir.Value], *, clusterSizeX: _Optional[_ods_ir.Value] = None, clusterSizeY: _Optional[_ods_ir.Value] = None, clusterSizeZ: _Optional[_ods_ir.Value] = None, dynamicSharedMemorySize: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, cooperative: _Optional[bool] = None, asyncObject: _Optional[_ods_ir.Value] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    if bool(cooperative): attributes["cooperative"] = _ods_ir.UnitAttr.get(
      _ods_get_default_loc_context(loc))
    results = []
    if asyncToken is not None: results.append(asyncToken)
    _ods_successors = None
  ...
  def cooperative(self) -> bool:
    return "cooperative" in self.operation.attributes

  @cooperative.setter
  def cooperative(self, value):
    if bool(value):
      self.operation.attributes["cooperative"] = _ods_ir.UnitAttr.get()
    elif "cooperative" in self.operation.attributes:
      del self.operation.attributes["cooperative"]
...
class LaunchFuncOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def cooperative(self) -> bool:
    return "cooperative" in self.attributes
