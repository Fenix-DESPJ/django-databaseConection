...
@_ods_cext.register_operation(_Dialect)
class CoreIdOp(_ods_ir.OpView):
  OPERATION_NAME = "tpu.core_id"
...
@_ods_cext.register_op_adaptor(CoreIdOp)
class CoreIdOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "tpu.core_id"
...
class EnqueueDMAOp(_ods_ir.OpView):
  ...
  @builtins.property
  def target_semaphore(self) -> _Optional[_ods_ir.Value[_ods_ir.MemRefType]]:
    operand_range = _ods_segmented_accessor(
         self.operation.operands,
  ...
  @builtins.property
  def subcore_id(self) -> _Optional[_ods_ir.Value[_ods_ir.IntegerType]]:
    operand_range = _ods_segmented_accessor(
         self.operation.operands,
...
class MatmulOp(_ods_ir.OpView):
  ...
  def __init__(self, result: _ods_ir.Type, lhs: _ods_ir.Value[_ods_ir.VectorType], rhs: _ods_ir.Value[_ods_ir.VectorType], acc: _ods_ir.Value[_ods_ir.VectorType], transpose_lhs_hint: _Union[bool, _ods_ir.BoolAttr], *, transpose_lhs: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, transpose_rhs: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, precision: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, dimension_numbers: _Optional[_Union[_Any, _ods_ir.Attribute]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    ...
    attributes["transpose_lhs_hint"] = (transpose_lhs_hint if (
    isinstance(transpose_lhs_hint, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('BoolAttr')) else
      _ods_ir.AttrBuilder.get('BoolAttr')(transpose_lhs_hint, context=_ods_context))
    results = []
    results.append(result)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
  ...
  @builtins.property
  def transpose_lhs_hint(self) -> _ods_ir.BoolAttr:
    return self.operation.attributes["transpose_lhs_hint"]

  @transpose_lhs_hint.setter
  def transpose_lhs_hint(self, value: _ods_ir.BoolAttr):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["transpose_lhs_hint"] = value
...
class MatmulOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def transpose_lhs_hint(self) -> _ods_ir.BoolAttr:
    return self.attributes["transpose_lhs_hint"]
...
class ReinterpretCastOp(_ods_ir.OpView):
  ...
  def __init__(self, result: _ods_ir.Type, input: _ods_ir.Value[_ods_ir.MemRefType], dynamic_sizes: _Sequence[_ods_ir.Value[_ods_ir.IntegerType]], *, dynamic_offset: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(input)
    operands.append(dynamic_offset)
    operands.append(_get_op_results_or_values(dynamic_sizes))
    _ods_context = _ods_get_default_loc_context(loc)
    results = []
    results.append(result)
  ...
  @builtins.property
  def dynamic_offset(self) -> _Optional[_ods_ir.Value[_ods_ir.IntegerType]]:
    operand_range = _ods_segmented_accessor(
         self.operation.operands,
         self.operation.attributes["operandSegmentSizes"], 1)
    return operand_range[0] if len(operand_range) > 0 else None
...
@_ods_cext.register_operation(_Dialect)
class SubcoreIdOp(_ods_ir.OpView):
  OPERATION_NAME = "tpu.subcore_id"
...
@_ods_cext.register_op_adaptor(SubcoreIdOp)
class SubcoreIdOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "tpu.subcore_id"
...
class WaitDMAOp(_ods_ir.OpView):
  ...
  def __init__(self, source: _ods_ir.Value[_ods_ir.MemRefType], target: _ods_ir.Value[_ods_ir.MemRefType], wait_target: _Union[bool, _ods_ir.BoolAttr], *, source_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, target_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, device_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, core_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, subcore_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, priority: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, strict_ordering: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(source)
    ...
    if strict_ordering is not None: attributes["strict_ordering"] = (strict_ordering if (
        ...
        not _ods_ir.AttrBuilder.contains('BoolAttr')) else
          _ods_ir.AttrBuilder.get('BoolAttr')(strict_ordering, context=_ods_context))
    attributes["wait_target"] = (wait_target if (
    isinstance(wait_target, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('BoolAttr')) else
      _ods_ir.AttrBuilder.get('BoolAttr')(wait_target, context=_ods_context))
    results = []
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
  ...
  @builtins.property
  def wait_target(self) -> _ods_ir.BoolAttr:
    return self.operation.attributes["wait_target"]

  @wait_target.setter
  def wait_target(self, value: _ods_ir.BoolAttr):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["wait_target"] = value

@_ods_cext.register_op_adaptor(WaitDMAOp)
class WaitDMAOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "tpu.wait_dma"
  ...
  @builtins.property
  def wait_target(self) -> _ods_ir.BoolAttr:
    return self.attributes["wait_target"]

def wait_dma(source: _ods_ir.Value[_ods_ir.MemRefType], target: _ods_ir.Value[_ods_ir.MemRefType], wait_target: _Union[bool, _ods_ir.BoolAttr], *, source_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, target_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, device_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, core_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, subcore_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, priority: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, strict_ordering: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None) -> WaitDMAOp:
  return WaitDMAOp(source=source, target=target, wait_target=wait_target, source_semaphore=source_semaphore, target_semaphore=target_semaphore, device_id=device_id, core_id=core_id, subcore_id=subcore_id, priority=priority, strict_ordering=strict_ordering, loc=loc, ip=ip)
